  ...
  useEffect(() => {
    const fetchBrnoEvents = async () => {
      try {
        ...
        const mappedEvents: AppEvent[] = data.features.map(
          (feature: BrnoApiFeature) => {
            const props = feature.properties;
            const coords = feature.geometry?.coordinates;

            const cleanTitle =
              decodeHTMLEntities(props.name) || "Akce bez názvu";
            ...
            const validImage =
              props.first_image ||
              `https://picsum.photos/seed/${props.ObjectId || Math.random()}/400/250`;
      ...
      <BrowserRouter>
        ...
        <main>
          <Routes>
            ...
            <Route
              path="/my-events"
              element={<MyEvents events={events} toggleSaved={toggleSaved} />}
            />
